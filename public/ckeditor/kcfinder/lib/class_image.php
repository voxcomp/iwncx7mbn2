...
abstract class image
{
     ...
     * @param mixed $image
     * @return object */
    final public static function factory($driver, $image, array $options = [])
    {
     ...
     *
     * @return string */
    final public static function getDriver(array $drivers = ['gd'])
    {
    ...
    final protected function buildImage($image)
    {
        ...
        if ($image instanceof $class) {
            ...
            [$key, $width] = each($image);
            [$key, $height] = each($image);
