...
CKEDITOR.editorConfig = function( config ) {
	...
	config.removeButtons = 'Save,NewPage,Preview,Print,Source,Templates,Cut,Copy,PasteText,PasteFromWord,Redo,Find,Replace,SelectAll,Scayt,Form,Checkbox,Radio,TextField,Textarea,Select,Button,ImageButton,HiddenField,Underline,Strike,Subscript,Superscript,CopyFormatting,BidiRtl,BidiLtr,Language,Link,Unlink,Anchor,Flash,Table,HorizontalRule,Smiley,SpecialChar,PageBreak,Iframe,Font,FontSize,Styles,BGColor,TextColor,Maximize,ShowBlocks,About';
    ...
    config.uploadUrl = '/ckeditor/kcfinder/upload.php?opener=uploadimage&type=files&format=json';
